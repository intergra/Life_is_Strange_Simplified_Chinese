...
对白会根据说话者的身份、年龄、性格、人物关系和当下情绪调整措辞。Max 的旁白、
...
- 游戏选择已有存档后，部分界面会重新读取存档关联的语言设置；本 Mod 已提供相应兼容处理，
  正常安装后主菜单、存档选择界面和进入游戏后的章节内容都应保持简体中文。
